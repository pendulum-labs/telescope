...
class QueryClientImpl {
    ...
    denomTrace(request) {
        ...
        return promise.then(data => query_1.QueryDenomTraceResponse.decode(new _m0.Reader(data)));
    }
    denomTraces(request = {
        ...
        return promise.then(data => query_1.QueryDenomTracesResponse.decode(new _m0.Reader(data)));
    }
    params(request = {}) {
